<x-layouts.app>
    ...
    <div class="mb-6 flex items-center text-sm">
        ...
        <span class="text-gray-500 dark:text-gray-400">Tampilan</span>
    </div>

    <!-- Page Title -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Tampilan</h1>
            ...
            <div class="flex-1">
                <div
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-4">
                            <label for="theme"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tema</label>
